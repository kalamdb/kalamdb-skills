...
async function verifyCanonical() {
  const expectedFiles = [
    ...
    path.join("examples", "dart-sync.md"),
    ...
    path.join("references", "dart-sync.md"),
    path.join("references", "dart-sync-api.md"),
    path.join("references", "orms.md"),
    path.join("references", "rls-policies.md"),
